		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group receivers-list">
					<label><?php echo e(__('Select Receiver Group')); ?></label>
					<select class="form-control select2" id="wa-contacts"  name="group">
						<?php $__currentLoopData = $groups ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($group->id); ?>" data-contacts="<?php echo e($group->contacts); ?>"><?php echo e($group->name); ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</select>
				</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<textarea class="form-control" required="" id="to" placeholder="<?php echo e(__('Use comma for multiple numbers')); ?>"></textarea>
...
<script src="<?php echo e(asset('assets/js/pages/bulk/bulkmessage.js?v=1.2')); ?>" ></script>

<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/wasender/resources/views/user/whatsapp/bulk/multiple.blade.php ENDPATH**/ ?>