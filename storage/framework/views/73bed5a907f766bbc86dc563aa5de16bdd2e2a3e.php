							...
							<div class="tab-pane fade show active" id="home4" role="tabpanel" aria-labelledby="home-tab4">
								<form method="POST" action="<?php echo e(route('admin.page-settings.update','primary_data')); ?>" class="ajaxform" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label><?php echo e(__('Header Logo')); ?></label>
									...
									<div class="form-group">
										<label><?php echo e(__('Footer Logo (light colour recommended)')); ?></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/whatsserver/resources/views/admin/settings/page-settings.blade.php ENDPATH**/ ?>