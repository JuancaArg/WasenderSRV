								...
								<form method="POST" action="<?php echo e(route('admin.page-settings.update','primary_data')); ?>" class="ajaxform" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<select class="form-control" name="theme_path">
											<option value="frontend.index" <?php echo e($theme_path == 'frontend.index' ? 'selected' : ''); ?>><?php echo e(__('Theme 1')); ?></option>
											<option value="frontend.index-1" <?php echo e($theme_path == 'frontend.index-1' ? 'selected' : ''); ?>><?php echo e(__('Theme 2')); ?></option>
							...
							<div class="tab-pane fade" id="why-choose" role="tabpanel" aria-labelledby="profile-tab4">
								<form method="POST" action="<?php echo e(route('admin.page-settings.update','why-choose')); ?>" class="ajaxform" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<input type="text" name="data[title]" class="form-control" value="<?php echo e($why_choose->title ?? ''); ?>" required="" placeholder="<?php echo e(__('Why choose WASender 🎖️')); ?>">
									</div>
									<div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/wasender/resources/views/admin/settings/page-settings.blade.php ENDPATH**/ ?>