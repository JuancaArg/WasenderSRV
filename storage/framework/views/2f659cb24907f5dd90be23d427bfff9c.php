...
<ul class="navbar-nav">
  ...
  <li class="nav-item ">
    <a class="nav-link <?php echo e(Request::is('user/webhooks*') ? 'active' : ''); ?>" href="<?php echo e(url('user/webhooks')); ?>">
     <i class="fi fi-rs-chart-connected"></i>
      <span class="nav-link-text"><?php echo e(__('Webhook Logs')); ?></span>
    </a>
  </li>
</ul>
...
<?php /**PATH /Volumes/my-works/laravel/wasender/resources/views/layouts/main/user.blade.php ENDPATH**/ ?>