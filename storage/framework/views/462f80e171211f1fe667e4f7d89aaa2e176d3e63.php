	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4>Sent Custom Text</h4>
			</div>
			<div class="card-body">
				<form method="POST" action="<?php echo e(route('user.sent.customtext')); ?>">
					<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/whatscloud/resources/views/user/whatsapp/customtext.blade.php ENDPATH**/ ?>