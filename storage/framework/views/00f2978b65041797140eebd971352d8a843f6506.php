...
<div class="col-sm-12">
   ...
   <form class="installer_form_instant_reload" method="post" action="<?php echo e(route('install.store')); ?>">
      ...
      <div class="form-group mt-5">
         ...
         <input type="text" name="site_name" class="form-control" required="" placeholder="QServe" maxlength="20">
      </div>
...
<?php echo $__env->make('installer.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/whatsserver/resources/views/installer/info.blade.php ENDPATH**/ ?>