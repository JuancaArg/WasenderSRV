        ...
        <div class="col-lg-6 col-7">
          ...
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links">
              <li class="breadcrumb-item"><a href="<?php echo e(url('/user/dashboard')); ?>"><i class="fas fa-home"></i></a></li>
              <?php if(isset($title)): ?>
              ...
              <li class="breadcrumb-item"><a href="#"><?php echo e($segment); ?></a></li>
...
</div><?php /**PATH /Volumes/my-works/laravel/whatscloud/resources/views/layouts/main/headersection.blade.php ENDPATH**/ ?>