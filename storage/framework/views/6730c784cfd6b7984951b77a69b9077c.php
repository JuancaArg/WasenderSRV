	...
	<div class="col-12">
		<div class="card">
			...
			<div class="card-body">
				...
				<br>
				<strong><?php echo e(__('Run Every 1 Minutes')); ?></strong>
			</div>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4><?php echo e(__('Execute webhooks requests')); ?></h4>
			</div>
			<div class="card-body">
				<div class="code"><p class="text-white">curl -s <?php echo e(url('/cron/execute-webhook')); ?></p></div>
				<br>
				<strong><?php echo e(__('Run Every 1 Minutes')); ?></strong>
			</div>
		</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/wasender/resources/views/admin/cron/index.blade.php ENDPATH**/ ?>