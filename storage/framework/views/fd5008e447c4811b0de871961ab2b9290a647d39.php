							...
							<td class="text-right">
								<div class="btn-group mb-2 float-right">
									...
									<div class="dropdown-menu">
										...
										<a class="dropdown-item has-icon delete-confirm" href="javascript:void(0)" data-action="<?php echo e(route('admin.partner.destroy',$row->id)); ?>"><i class="fas fa-trash"></i><?php echo e(__('Remove Category')); ?></a>
									</div>
								</div>								
							</td>
						</tr>
      ...
      <div class="modal-content">
         <form method="POST" action="<?php echo e(route('admin.partner.store')); ?>" class="ajaxform_instant_reload" enctype="multipart/form-data">
            ...
            <div class="modal-header">
               <h3><?php echo e(__('Create brand')); ?></h3>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/whatsserver/resources/views/admin/brand/index.blade.php ENDPATH**/ ?>