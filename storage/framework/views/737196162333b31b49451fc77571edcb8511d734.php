...
<div class="row justify-content-center">
	<div class="col-12">
		<div class="card">
			...
			<div class="card-body">
				<form method="POST" action="<?php echo e(route('user.send.reply')); ?>">
					<?php echo csrf_field(); ?>
				...
				<div class="form-group row mb-4">
					<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"><?php echo e(__('Message Id')); ?></label>
					<div class="col-sm-12 col-md-7">
						<input type="text" name="message_id" value="<?php echo e(env('REPLY_ID')); ?>" class="form-control" required="">
					</div>
				</div>
...
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/whatscloud/resources/views/user/whatsapp/message/reply.blade.php ENDPATH**/ ?>