...
<form class="ajaxform_instant_reload" method="post" action="<?php echo e(route('admin.page.update',$info->id)); ?>">
	...
	<div class="row">
		<div class="col-lg-5">
			<strong><?php echo e(__('Edit custom page')); ?></strong>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/whatsserver/resources/views/admin/page/edit.blade.php ENDPATH**/ ?>