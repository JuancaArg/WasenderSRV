         ...
         <form type="POST" action="<?php echo e(route('user.contact.send-template-bulk')); ?>" class="ajaxform bulk_send_form">
            ...
            <div class="modal-body">
               ...
               <div class="form-group d-flex">
                  ...
                  <label class="mt-1 ml-1" for="plain-text">
                     <h4><?php echo e(__('Sent this template to all user?')); ?></h4>
                  </label>
               </div>
            </div>
...
<script src="<?php echo e(asset('assets/js/pages/bulk/wa-bulk-index.js')); ?>" ></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/whatsserver/resources/views/user/whatsapp/bulk/index.blade.php ENDPATH**/ ?>