			...
			<div class="card">
				<div class="card-body">
					...
					<div class="from-group row  mt-2">
						<label  class="col-lg-12"><?php echo e(__('Blog Image (Preview)')); ?></label>
						<div class="col-lg-12">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/wasender/resources/views/admin/blogs/create.blade.php ENDPATH**/ ?>