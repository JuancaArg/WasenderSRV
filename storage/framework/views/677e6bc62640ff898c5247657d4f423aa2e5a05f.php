    ...
    <div class="col-sm-12">
        <div class="row">
           <div class="col-sm-8 d-flex">
            ...
            <label class="mt-1 ml-1" for="template-status"><h4><?php echo e(__('Make it active template?')); ?></h4></label>
        </div>
        <div class="col-sm-4">
...
</form><?php /**PATH /Volumes/my-works/laravel/whatsserver/resources/views/user/template/edit/button.blade.php ENDPATH**/ ?>