   ...
   <table class="header">
      <tr>
         ...
         <td width="50%" align="right">
            <font class="unpaid"><?php echo e(__('Unpaid')); ?></font><br />
         </td>
      </tr>
   </table>
</div>
...
<div class="row">
   ...
   <div class="radiocontainer gateways col-sm-4">
      ...
      <label for="gateway_<?php echo e($gateway->id); ?>"><img src="<?php echo e(asset($gateway->logo)); ?>" class="gateway-img"/></label>
   </div>
   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
</div>
<div class="clear"></div>
   ...
   <form method="post" action="<?php echo e(url('user/make-subscribe/'.$gateway->id.'/'.$plan->id)); ?>" class="ajaxform_next_page" enctype="multipart/form-data">
      ...
      <div class="table-responsive">
         ...
         <table class="table mt-2 items">
            ...
            <tr>
               <td><?php echo $gateway->comment; ?></td>
            </tr>
         </table>
         <?php endif; ?>
...
<div class="col-sm-12">
   ...
   <a href="<?php echo e(url('/user/subscription')); ?>" class="btn btn-neutral  col-12 submit-button mb-2 mt-2"><?php echo e(__('Cancel Payment')); ?></a>
</div>
<?php $__env->stopSection(); ?>
<?php $__env->startPush('js'); ?>
<script src="<?php echo e(asset('assets/js/pages/user/subscription-pay.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('gateways.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/wasender/resources/views/user/subscription/payment.blade.php ENDPATH**/ ?>