...
<div class="row ">
    ...
    <div class="col-lg-7 mt-5">
        <form class="ajaxform" action="<?php echo e(route('user.profile.update','general')); ?>" enctype="multipart/form-data">
        	<?php echo csrf_field(); ?>
...
<div class="row ">
    ...
    <div class="col-lg-7">
    	<form class="ajaxform_reset_form" action="<?php echo e(route('user.profile.update','password')); ?>">
    		<?php echo csrf_field(); ?>
    		<?php echo method_field('PUT'); ?>
        <div class="card">
            <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/whatsserver/resources/views/user/profile/settings.blade.php ENDPATH**/ ?>