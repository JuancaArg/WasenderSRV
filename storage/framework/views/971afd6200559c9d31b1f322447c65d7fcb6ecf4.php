         ...
         <div class="modal-body">
            ...
            <div class="form-group">
               ...
               <select class="form-control select2" id="contacts"  name="contacts[]"  required="" data-toggle="select" multiple="">
                  ...
                  <option value="<?php echo e($contact->id); ?>" data-contact><?php echo e($contact->name); ?> (+<?php echo e($contact->phone); ?>)</option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               </select>
            </div>
            <div class="form-group">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/whatsserver/resources/views/user/template/template.blade.php ENDPATH**/ ?>