                  ...
                  <div class="postbox__content">                    
                     ...
                     <div class="postbox__thumb2 mb-60">
                        <div class="postbox__text text-justify">
                           <p class="text-justify"><?php echo filterXss($page->description->value ?? ''); ?></p>
                        </div>
                     </div>                     
                  </div>
               </article>              
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/wasender/resources/views/frontend/page.blade.php ENDPATH**/ ?>