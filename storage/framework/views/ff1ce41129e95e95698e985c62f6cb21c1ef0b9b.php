    ...
    <div class="col-lg-7 mt-5">
        <form class="ajaxform" action="<?php echo e(route('admin.developer-settings.update',$id)); ?>">
            ...
            <div class="card-body">
               ...
               <div class="from-group row mt-2">
                    <label class="col-lg-12"><?php echo e(__('Delay Time For Per Message (Millisecond)')); ?></label>
                    <div class="col-lg-12">
                        <input type="number" name="DELAY_TIME"  value="<?php echo e(env('DELAY_TIME')); ?>" required="" class="form-control" placeholder="1000 ms = 1 sec">
                    </div>
                </div> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/wasender/resources/views/admin/developer/whatsapp.blade.php ENDPATH**/ ?>