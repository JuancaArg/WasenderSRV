					...
					<article class="postbox__item format-image transition-3">
						<div class="postbox__content">
							...
							<div class="postbox__thumb2 mb-60">
								<div class="postbox__text">
									<p><?php echo e($blog->longDescription->value ?? ''); ?></p>
								</div>
							</div>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/whatsserver/resources/views/frontend/blog/show.blade.php ENDPATH**/ ?>