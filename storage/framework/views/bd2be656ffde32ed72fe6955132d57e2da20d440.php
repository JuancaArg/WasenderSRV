                                      ...
                                      <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="myTextarea4" class="form-control h-200" required="" name="message" placeholder="<?php echo e(__('Example: This is a list')); ?>"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/wasender/resources/views/user/singlesend/create.blade.php ENDPATH**/ ?>