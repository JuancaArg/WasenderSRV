	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4>Sent Document By Link</h4>
			</div>
			<div class="card-body">
				<form method="POST" action="<?php echo e(route('user.send.document.useinglink')); ?>">
					<?php echo csrf_field(); ?>
				...
				<div class="form-group row mb-4">
					<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"><?php echo e(__('Document Caption')); ?></label>
					<div class="col-sm-12 col-md-7">
...
<?php echo $__env->make('layouts.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/my-works/laravel/whatscloud/resources/views/user/whatsapp/message/message_with_docuemnt_link.blade.php ENDPATH**/ ?>