<header>
            ...
            <div class="row align-items-center">
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-6">
                  <div class="tp-header__right-two d-flex align-items-center justify-content-end">
                     <?php if(!Auth::check()): ?>
                     <a class="tp-header__login d-none d-lg-block" href="<?php echo e(url('/login')); ?>">
                     ...
                     <?php endif; ?>
                     <a class="tp-btn-blue d-none d-md-block" href="<?php echo e(!Auth::check() ? url('/pricing') : url('/login')); ?>"><span><?php echo e(!Auth::check() ? __('Get Started') : __('Dashboard')); ?></span></a>
         ...
         <div class="tpoffcanvas__info">
            ...
            <div class="tp-info-wrapper mb-20 d-flex align-items-center">
               ...
               <div class="tpoffcanvas__info-address">
                  ...
                  <a href="#" target="_blank"><?php echo e(get_option('primary_data',true)->address ?? ''); ?></a>
               </div>
            </div>
         </div>
   ...
   </div><?php /**PATH /Volumes/my-works/laravel/whatsserver/resources/views/frontend/layouts/header-1.blade.php ENDPATH**/ ?>